...
const findTeacherChildren = async (id : string): Promise<Children[] | null> => {
  const accessToken = localStorage.getItem('ACCESS_TOKEN');
  try {
    const response = await axios.get(`${API_BASE_URL}api/teacher/member/group/${id}`, {
      headers: {
...
export default findTeacherChildren;
